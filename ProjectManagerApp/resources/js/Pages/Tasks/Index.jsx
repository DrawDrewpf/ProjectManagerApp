...
export default function Index({ auth, tasks, queryParams = null, isMyTasks = false }) { 
    ...
    const pageTitle = isMyTasks ? "My Tasks" : "All Tasks";
    const fetchUrl = isMyTasks ? route('tasks.myTasks') : route('tasks.index');
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100 flex-grow flex flex-col">
                            <div className="flex-grow">
                                ...
                                <DataTable
                                    fetchUrl={fetchUrl}
                                    columns={columns}
                                    initialQueryParams={tasks.meta?.current_query_params || queryParams || {}}
                                    createUrl={route('tasks.create')}
                                    createButtonLabel="Add New Task"
